...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "Quantile": ".types",
    "ReliabilityPoint": ".types",
    "Sample": ".types",
    "ScorecardModel": ".types",
    "SkillByLeadPoint": ".types",
    "SkillKpis": ".types",
    "Summary": ".types",
    ...
    "VectorMetric": ".types",
    "VectorMetricCounter": ".types",
    "VectorMetricDistribution": ".types",
    "VectorMetricGauge": ".types",
    "VectorMetricHistogram": ".types",
    "VectorMetricIntervalMs": ".types",
    "VectorMetricKind": ".types",
    "VectorMetricSet": ".types",
    "VectorMetricSummary": ".types",
    "VectorMetricTimestamp": ".types",
    "WeatherCode": ".types",
    "__version__": ".version",
    "cyclones": ".cyclones",
