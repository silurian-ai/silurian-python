...
from .raw_client import RawForecastClient
import typing
...
from .raw_client import AsyncRawForecastClient
...
class ForecastClient:
    ...
    def daily(
        ...
        *,
        ...
        """
        response = self._raw_client.daily(
    ...
    def hourly(
        ...
        *,
        ...
        """
        response = self._raw_client.hourly(
            latitude=latitude,
            longitude=longitude,
            timezone=timezone,
            units=units,
...
class AsyncForecastClient:
    ...
    async def daily(
        ...
        *,
        ...
        asyncio.run(main())
        """
        response = await self._raw_client.daily(
            latitude=latitude, longitude=longitude, timezone=timezone, units=units, request_options=request_options
        )
        return response.data
    ...
    async def hourly(
        ...
        *,
        ...
        asyncio.run(main())
        """
        response = await self._raw_client.hourly(
            latitude=latitude,
            longitude=longitude,
            timezone=timezone,
            units=units,
